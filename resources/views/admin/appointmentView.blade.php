							...
							$.ajax({
								...
								success: function(response){
									...
									if(response=='success')
									{
										$('#calendar').fullCalendar('refetchEvents');
										$('#myModal').hide();
										$('#app-succs-mssg').html("<div class='alert alert-success'><button type='button' class='close' data-dismiss='alert'>×</button> L'appuntamento è stato cancellato con successo.</div>");
									}
								}
							});
						},
						...
						$.ajax({
							...
							success: function(response){
								if(response=='success')
								{
									$('#calendar').fullCalendar('refetchEvents');
									$('#myModal').hide();
									$('#app-succs-mssg').html("<div class='alert alert-success'><button type='button' class='close' data-dismiss='alert'>×</button> L'appuntamento è stato aggiornato con successo.</div>");
								}else{
